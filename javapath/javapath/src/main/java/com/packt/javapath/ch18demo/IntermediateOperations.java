...
public class IntermediateOperations {
    ...
    private static void sorting() {
        ...
        System.out.println();
        list.stream().sorted(Comparator.reverseOrder()).forEach(System.out::print);  //prints: 54321
    ...
    private static void mapping(){
        System.out.println();
        List<String> list = List.of("1", "2", "3", "4", "5");
        list.stream().map(s -> s + s).forEach(System.out::print);  //prints: 1122334455
        ...
        list.stream().map(Integer::valueOf)
                ...
                .mapToObj(Double::toString)
                .map(s -> s + " ")
                .forEach(System.out::print);  //prints: 1.0 1.0 2.0 1.0 2.0 3.0 1.0 2.0 3.0 4.0
    }
